...
export class Logos1 {
  @Input()
  logo5Alt: string = 'Logo de Parceiros'
  @Input()
  logo3Src: string =
  ...
  @Input()
  logo4Alt: string = 'Logo de Afiliação'
  @Input()
  logo2Alt: string = 'Logo de Guia Local'
  @Input()
  logo6Alt: string = 'Logo de Carreiras'
  @Input()
  logo4Src: string =
  ...
  @Input()
  logo3Alt: string = 'Logo do Marketplace'
  @Input()
  logo1Alt: string = 'Logo da Franquia Virtual'
  @Input()
  logo5Src: string =
